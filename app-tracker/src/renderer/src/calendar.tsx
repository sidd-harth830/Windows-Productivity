  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-[rgba(var(--a1),0.15)] [&:has([aria-selected].day-outside)]:bg-[rgba(var(--a1),0.05)] [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-range-start)]:rounded-l-md first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md",
        ...
        day_range_middle: "aria-selected:!bg-transparent aria-selected:!text-[var(--text)] !shadow-none !rounded-none",
